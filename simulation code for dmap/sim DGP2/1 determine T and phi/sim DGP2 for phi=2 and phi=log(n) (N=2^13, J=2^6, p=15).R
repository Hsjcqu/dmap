...
T_vec = 1:8
n_T = length(T_vec)
result_compare1 = repfun2_compare_acrossT(num_rep=200, N=2^13, n_test=100, J=2^6, p=15,
...
T_vec = 1:8
n_T = length(T_vec)
result_compare2 = repfun2_compare_acrossT(num_rep=200, N=2^13, n_test=100, J=2^6, p=15,
...
### Case 2a: grouping candidate models, R2 = 0.5  ###
T_vec = 1:8
n_T = length(T_vec)
result_compare3 = repfun2_compare_acrossT(num_rep=200, N=2^13, n_test=100, J=2^6, p=15,
...
### Case 2b: grouping candidate models, R2 = 0.9  ###
T_vec = 1:8
n_T = length(T_vec)
result_compare4 = repfun2_compare_acrossT(num_rep=200, N=2^13, n_test=100, J=2^6, p=15,
