...
plot(T_vec, MSPE_T_compare[,1], ylim=c(range(MSPE_T_compare)[1], 1.4), type="n",
...
windows(height=4, width=4.5, points=9)
par(mar=c(4,4,2,2), font=3, bg="white", font.lab=3, font.axis=5)   
plot(T_vec, RISK_T_compare[,1], ylim=c(range(RISK_T_compare)[1], 0.4), type="n",
...
# png(file="xifuweight.png", width=4, height=4, pointsize =9, units="in",res=400)
par(mar=c(4,4,2,2), font=3, bg="white", font.lab=3, font.axis=5)   
plot(T_vec, MSPE_T_compare2[,1], ylim=c(range(MSPE_T_compare2)[1], 0.475), type="n",
      xlab="Number of iterations T", ylab="MSPE")
for(i in 1:length(name_method2)){
...
windows(height=4, width=4.5, points=9)
par(mar=c(4,4,2,2), font=3, bg="white", font.lab=3, font.axis=5)   
plot(T_vec, RISK_T_compare2[,1], ylim=c(range(RISK_T_compare2)[1], 0.37), type="n",
      xlab="Number of iterations T", ylab="Risk")
for(i in 1:length(name_method2)){
...
# png(file="xifuweight.png", width=4, height=4, pointsize =9, units="in",res=400)
par(mar=c(4,4,2,2), font=3, bg="white", font.lab=3, font.axis=5)   
plot(T_vec, MSPE_T_compare3[,1], ylim=c(range(MSPE_T_compare3)[1], 1.728), type="n",
      xlab="Number of iterations T", ylab="MSPE")
for(i in 1:length(name_method2)){
...
windows(height=4, width=4.5, points=9)
par(mar=c(4,4,2,2), font=3, bg="white", font.lab=3, font.axis=5)   
plot(T_vec, RISK_T_compare3[,1], ylim=c(range(RISK_T_compare3)[1], 0.735), type="n",
      xlab="Number of iterations T", ylab="Risk")
for(i in 1:length(name_method2)){
...
# png(file="xifuweight.png", width=4, height=4, pointsize =9, units="in",res=400)
par(mar=c(4,4,2,2), font=3, bg="white", font.lab=3, font.axis=5)   
plot(T_vec, MSPE_T_compare4[,1], ylim=c(range(MSPE_T_compare4)[1], 0.8425), type="n",
      xlab="Number of iterations T", ylab="MSPE")
for(i in 1:length(name_method2)){
...
windows(height=4, width=4.5, points=9)
par(mar=c(4,4,2,2), font=3, bg="white", font.lab=3, font.axis=5)   
plot(T_vec, RISK_T_compare4[,1], ylim=c(range(RISK_T_compare4)[1], 0.74), type="n",
      xlab="Number of iterations T", ylab="Risk")
for(i in 1:length(name_method2)){
...
plot(T_vec, MSPE_T_compare[,1], ylim=c(range(MSPE_T_compare)[1], 1.26), type="n",
      xlab="Number of iterations T", ylab="MSPE")
for(i in 1:length(name_method2)){
 lines(T_vec, MSPE_T_compare[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, MSPE_T_compare[, i], col=i+1, pch=i+1)
...
plot(T_vec, MSPE_T_compare2[,1], ylim=c(range(MSPE_T_compare2)[1], 0.318), type="n",
      xlab="Number of iterations T", ylab="MSPE")
for(i in 1:length(name_method2)){
 lines(T_vec, MSPE_T_compare2[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, MSPE_T_compare2[, i], col=i+1, pch=i+1)
...
plot(T_vec, MSPE_T_compare3[,1], ylim=c(range(MSPE_T_compare3)[1], 1.4075), type="n",
      xlab="Number of iterations T", ylab="MSPE")
for(i in 1:length(name_method2)){
 lines(T_vec, MSPE_T_compare3[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, MSPE_T_compare3[, i], col=i+1, pch=i+1)
...
plot(T_vec, MSPE_T_compare4[,1], ylim=c(range(MSPE_T_compare4)[1], 0.5005), type="n",
      xlab="Number of iterations T", ylab="MSPE")
for(i in 1:length(name_method2)){
 lines(T_vec, MSPE_T_compare4[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, MSPE_T_compare4[, i], col=i+1, pch=i+1)
...
plot(T_vec, RISK_T_compare[,1], ylim=c(range(RISK_T_compare)[1], 0.29), type="n",
      xlab="Number of iterations T", ylab="Risk")
for(i in 1:length(name_method2)){
 lines(T_vec, RISK_T_compare[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, RISK_T_compare[, i], col=i+1, pch=i+1)
...
plot(T_vec, RISK_T_compare2[,1], ylim=c(range(RISK_T_compare2)[1], 0.22), type="n",
      xlab="Number of iterations T", ylab="Risk")
for(i in 1:length(name_method2)){
 lines(T_vec, RISK_T_compare2[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, RISK_T_compare2[, i], col=i+1, pch=i+1)
...
plot(T_vec, RISK_T_compare3[,1], ylim=c(range(RISK_T_compare3)[1], 0.405), type="n",
      xlab="Number of iterations T", ylab="Risk")
for(i in 1:length(name_method2)){
 lines(T_vec, RISK_T_compare3[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, RISK_T_compare3[, i], col=i+1, pch=i+1)
...
plot(T_vec, RISK_T_compare4[,1], ylim=c(range(RISK_T_compare4)[1], 0.4), type="n",
      xlab="Number of iterations T", ylab="Risk")
for(i in 1:length(name_method2)){
 lines(T_vec, RISK_T_compare4[, i], col=i+1, lty=i+1, lwd=1)
 points(T_vec, RISK_T_compare4[, i], col=i+1, pch=i+1)
...
## it seems that T=5 is good choice for DMAP-SL! 
